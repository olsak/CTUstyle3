...
\_def\.makerfc{\_ifx\rfc\.rfcactive
   ...
   \_bgroup\_rfcnum=0 \.rfclist\_egroup\_fi}
...
\_def\slides{\_par
  ...
  \_hoffset=12mm
  \_addto\wideformat{\_hoffset=12mm }
  \_everypar={}
  ...
  \_sdef{_item:x}{\_raise.4ex\_hbox{\Blue\.bf\_thefontsize[40].\Black} }

  \.Technika \_rm
  \_def\_titfont{\_typosize[30/39]\_bf\Blue}
  ...
  \_famvardef\_ttfont{\_setfontsize{mag1.1}\_tt}
...
\_ilink[pg:#1]{\.bigdotfont.}\_kern-4pt}%
...
beta(a) Sep.2013  First version CTUstyle3 for OpTeX released
