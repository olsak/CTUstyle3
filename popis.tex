...
Seznam obrázků a tabulek se vytiskne hned za obsahem. Tabulky tam mají
rezervován levý sloupec a obrázky pravý. Když nemáte například skoro žádné
tabulky ale máte velké množství obrázků, je na více stránkách v seznamu obsazen
jen pravý sloupec, což nepůsobí dobře. Můžete použít příkaz "\totf", který
způsobí obvyklé zaplnění obou sloupců a zařadí seznam obrázků hned za seznam
tabulek.
